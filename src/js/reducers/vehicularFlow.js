  ...
  switch (action.type) {
    case 'SET_VEHICULAR_REPORT':
      return [...state, {
        ...
        vehicle: action.report.vehicle.charAt(0).toUpperCase() + action.report.vehicle.slice(1, action.report.vehicle.indexOf('-')),
        zone: action.report.zone,
        site: action.report.site,
        front: action.report.front,
        back: action.report.back,
        video: action.report.video,
        brand: action.report.brand.charAt(0).toUpperCase() + action.report.brand.slice(1),
