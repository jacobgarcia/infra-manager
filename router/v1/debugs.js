...
.post((req,res) => {
  ...
  const filename = base64Img.imgSync(photo, 'static/photos', shortid.generate() + Date.now())
  const filename1 = base64Img.imgSync(pc1, 'static/photos', shortid.generate() + Date.now())
  const filename2 = base64Img.imgSync(pc2, 'static/photos', shortid.generate() + Date.now())
